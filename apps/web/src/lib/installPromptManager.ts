...
const DISMISSAL_STORAGE_KEY = "reelsavenow-pwa-dismissal";
const INSTALLED_STORAGE_KEY = "reelsavenow-pwa-installed";
const OPTED_OUT_STORAGE_KEY = "reelsavenow-pwa-opted-out";

// Re-show the prompt after whichever comes first. ReelSaveNow is an
