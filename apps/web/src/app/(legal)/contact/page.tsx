  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <a
        ...
        className="mt-4 inline-flex w-fit items-center gap-2 rounded-md border border-border bg-card px-4 py-3 text-sm font-medium transition-colors duration-150 ease-out hover:bg-secondary"
      >
        <Mail className="h-4 w-4" aria-hidden="true" />
        {CONTACT_EMAIL}
      </a>

      <h2 className="mt-6 text-h2">Copyright concerns</h2>
