...
const SECTIONS = [
  ...
  { id: "what-reelsavenow-does", label: "What ReelSaveNow Does" },
    ...
    <div className="flex flex-col gap-8">
      ...
      <LegalPageShell sections={SECTIONS}>
        <LegalSection id="agreement" title="Agreement to These Terms">
          <p>
            By using ReelSaveNow, you agree to these terms. If you don&apos;t agree with
        ...
        <LegalSection id="what-reelsavenow-does" title="What ReelSaveNow Does">
          <p>
            ReelSaveNow&apos;s main tool lets you preview and download media from{" "}
        ...
        <LegalSection id="acceptable-use" title="Acceptable Use">
          <p>
            You agree to use ReelSaveNow only for public content you&apos;re legally
          ...
          <ul className="flex flex-col gap-2 pl-5">
            <li className="list-disc">Use ReelSaveNow to access, download, or redistribute content you don&apos;t have the rights to.</li>
            ...
            <li className="list-disc">
              Use ReelSaveNow in any way that violates Instagram&apos;s own Terms of Use, or
              any applicable law.
            </li>
          </ul>
        </LegalSection>
        ...
        <LegalSection id="not-affiliated" title="Not Affiliated with Instagram or Meta">
          <p>
            ReelSaveNow is an independent tool and is not affiliated with, endorsed by, or
        ...
        <LegalSection id="intellectual-property" title="Intellectual Property">
          <p>
            ReelSaveNow doesn&apos;t claim any ownership or rights over content you preview
            or download through the service — that content belongs to its original
            creator, same as it did on Instagram. ReelSaveNow&apos;s own interface, design,
        ...
        <LegalSection id="no-warranty" title="No Warranty">
          <p>
            ReelSaveNow depends on Instagram&apos;s own, publicly-facing infrastructure,
        ...
        <LegalSection id="limitation-of-liability" title="Limitation of Liability">
          <p>
            To the fullest extent permitted by law, ReelSaveNow and its operator are not
