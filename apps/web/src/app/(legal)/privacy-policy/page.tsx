    ...
    <div className="flex flex-col gap-8">
      ...
      <LegalPageShell sections={SECTIONS}>
        <LegalSection id="overview" title="Overview">
          <p>
            ReelSaveNow is built around a simple principle: the less of your data we hold,
        ...
        <LegalSection id="what-we-collect" title="What We Collect">
          <p>ReelSaveNow&apos;s backend processes requests to do its job, but doesn&apos;t build a record of who you are.</p>
          <p>
        ...
        <LegalSection id="what-we-dont-collect" title="What We Don't Collect">
          ...
          <ul className="flex flex-col gap-2 pl-5">
            <li className="list-disc">
              No accounts, sign-in, or user profiles — ReelSaveNow doesn&apos;t ask for a
        ...
        <LegalSection id="local-storage" title="Local Storage on Your Device">
          ...
          <ul className="flex flex-col gap-2 pl-5">
            ...
            <li className="list-disc">
              Whether you&apos;ve installed ReelSaveNow as an app, or dismissed the install
              prompt, so we don&apos;t ask again on every visit.
            </li>
          </ul>
          <p>
            Because none of this is a tracking or advertising cookie, and none of it is
            shared with us or anyone else, ReelSaveNow doesn&apos;t show a cookie-consent
            banner — there&apos;s nothing here that requires one. If you&apos;d rather not
            keep this locally, clearing your browser&apos;s site data for ReelSaveNow removes
            it.
          </p>
          <p>
            ReelSaveNow&apos;s installable app also caches its own interface files (the code
        ...
        <LegalSection id="private-content-cookie" title="Your Own Private Content Feature: Session Cookie Handling">
          <div className="rounded-lg border border-primary/25 bg-primary/5 p-4">
            ...
            <p className="text-sm text-foreground">
              ReelSaveNow&apos;s main tool only works with public content. A separate,
        ...
        <LegalSection id="third-party-services" title="Third-Party Services We Use">
          <p>ReelSaveNow keeps its list of third parties short, on purpose:</p>
          <ul className="flex flex-col gap-2 pl-5">
            <li className="list-disc">
              ...
              Supabase doesn&apos;t currently receive any data from ReelSaveNow. If that
          ...
          <p>
            ReelSaveNow doesn&apos;t use any advertising networks, third-party analytics
        ...
        <LegalSection id="your-rights" title="Your Rights and Choices">
          <p>
            Because ReelSaveNow doesn&apos;t create an account or a personal profile for
          ...
          <ul className="flex flex-col gap-2 pl-5">
            ...
            <li className="list-disc">
              Clear your browser&apos;s local storage/site data for ReelSaveNow to remove
        ...
        <LegalSection id="childrens-privacy" title="Children's Privacy">
          <p>
            ReelSaveNow is not directed at children under 13, and we do not knowingly
