...
export default function PrivacyPolicyPage() {
  return (
    <div className="flex flex-col gap-4">
      ...
      <h2 className="mt-6 text-xl font-semibold">No accounts, no personal data collection</h2>
      ...
      <h2 className="mt-6 text-xl font-semibold">What we do log</h2>
      <p className="text-muted-foreground">
      ...
      <h2 className="mt-6 text-xl font-semibold">Instagram content isn&apos;t stored</h2>
      <p className="text-muted-foreground">
      ...
      <h2 className="mt-6 text-xl font-semibold">Local preferences</h2>
      <p className="text-muted-foreground">
